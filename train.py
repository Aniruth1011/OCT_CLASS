...
from methods.preprocess import preprocess_dir
from methods.trainCNN import train_model
...
def preprocess_data(x_trn_path , n_train):
    """
...
def main(x_trn_path, x_val_path,
    ...
    data_path_dict = preprocess_data(x_trn_path ,  n_train)
    """############################################################################
                        Train
    ############################################################################"""
